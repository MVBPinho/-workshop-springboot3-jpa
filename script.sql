--
-- Name: tb_catogory; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_catogory (
    id bigint NOT NULL,
...
--
-- Name: tb_catogory_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.tb_catogory_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: tb_catogory_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.tb_catogory_id_seq OWNED BY public.tb_catogory.id;
...
--
-- Name: tb_catogory id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_catogory ALTER COLUMN id SET DEFAULT nextval('public.tb_catogory_id_seq'::regclass);
...
--
-- Name: tb_catogory tb_catogory_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_catogory
    ADD CONSTRAINT tb_catogory_pkey PRIMARY KEY (id);
...
--
-- Name: tb_product_category fkp0tqaafg2nkg261v3f6kb0pll; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product_category
    ADD CONSTRAINT fkp0tqaafg2nkg261v3f6kb0pll FOREIGN KEY (category_id) REFERENCES public.tb_catogory(id);
